...
| File    |  Description           |
|-----------------|-------------------         |
| `DirLockedMeMain.java` | This component contains the Main method. It's the entry point of the program. |
| `DirFileMenuOptions.java` | This component contains methods for displaying menu options. |
| `DirHandleOptions.java` | This component contains methods for handling different options from user input and calls respective methods from FileOperations. |
